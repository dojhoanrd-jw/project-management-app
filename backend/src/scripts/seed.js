...
const OWNER = 'USER#admin@demo.com';
...
const buildProjects = () => {
  ...
  return [
    {
      PK: OWNER, SK: `PROJECT#${ids[0]}`,
      GSI1PK: 'MANAGER#sarah@demo.com', GSI1SK: `PROJECT#${ids[0]}`,
      ...
      dueDate: dateOffset(30), type: 'project', createdAt: dateOffset(-15),
    },
    {
      PK: OWNER, SK: `PROJECT#${ids[1]}`,
      GSI1PK: 'MANAGER#sarah@demo.com', GSI1SK: `PROJECT#${ids[1]}`,
      ...
      dueDate: dateOffset(14), type: 'project', createdAt: dateOffset(-30),
    },
    {
      PK: OWNER, SK: `PROJECT#${ids[2]}`,
      GSI1PK: 'MANAGER#admin@demo.com', GSI1SK: `PROJECT#${ids[2]}`,
      ...
      dueDate: dateOffset(-2), type: 'project', createdAt: dateOffset(-45),
    },
    {
      PK: OWNER, SK: `PROJECT#${ids[3]}`,
      GSI1PK: 'MANAGER#sarah@demo.com', GSI1SK: `PROJECT#${ids[3]}`,
      ...
      dueDate: dateOffset(60), type: 'project', createdAt: dateOffset(-10),
    },
  ];
};
